<template>
  ...
  >
    <div
      v-show="showAniStart"
      ref="enterpriseBapinLevel4"
      class="enterpriseBapinLevel4"
    >
...
export default {
  ...
  mounted() {
    this.$nextTick(() => {
      this.SVGAPlayer = new SVGA.Player(this.$refs.enterpriseBapinLevel4);
      this.$svgaParser.load(
        BapinEnterprise.bapinEnterprise4,
        (videoItem) => {
