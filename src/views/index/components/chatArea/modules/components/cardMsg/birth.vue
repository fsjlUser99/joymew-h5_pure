<template>
  <div class="cardMsg">
    ...
    >
      ...
      <div class="goldenCard" v-if="!dz_hltcard">
        {{ rankText }}
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    cardBg() {
      return this.message.advertiseContent.cardBg ? this.message.advertiseContent.cardBg : 'https://ustatic.joymew.com/joymewMp/zshl/cardTyp3.png';
    },
    textColor() {
      return this.message.advertiseContent.textColor || '#3333333';
    },
    dz_hltcard() {
...
.cardMsg {
  .hostCardWrap {
    ...
    background-image: url('https://ustatic.joymew.com/joymewMp/zshl/cardTyp3.png');
    padding: 23px 26px;
