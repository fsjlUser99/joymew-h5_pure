  ...
  computed: {
    ...
    cardBg() {
      return this.message.advertiseContent.cardBg
        ...
        : 'https://ustatic.joymew.com/joymewMp/zshl/bapin/hostCardBg.png';
    },
    textColor() {
      return this.message.advertiseContent.textColor || '#333333';
    },
  },
  components: {},
  methods: {
...
.cardMsg {
  ...
  .hostCardCt {
    ...
    .hostCardWrap {
      ...
      background-image: url('https://ustatic.joymew.com/joymewMp/zshl/bapin/hostCardBg.png');
      padding: 23px 26px;
