<template>
  <div class="happyQAWrap">
    ...
    <div
      v-if="gameStatus === 3"
      class="sheetPopup publicHvCenter"
    >
      <img
        src="https://static.hudongmiao.com/joymewH5/img/guessLanternRiddle/rankTitle.png"
        class="titleImg"
      />
...
.happyQAWrap {
  ...
  height: 100vh;
  overflow: hidden;
  background-image: url('https://static.hudongmiao.com/joymewH5/img/guessLanternRiddle/bg2.png');
  ...
  .sheetPopup {
    ...
    .rankBox {
      width: 718px;
      height: 1092px;
      background-image: url('https://static.hudongmiao.com/joymewH5/img/guessLanternRiddle/rankBg.png');
      background-size: 100% 100%;
      position: relative;
      padding-top: 94px;
      flex-direction: column;
      ...
      .pagination {
        ...
        .currentPage {
          width: 188px;
          height: 72px;
          background-image: url('https://static.hudongmiao.com/joymewH5/img/guessLanternRiddle/currentPage.png');
          background-size: 100% 100%;
          font-size: 48px;
          font-weight: 600;
          color: #ffffff;
        ...
        .pageCtrolBtn {
          ...
          background-size: 100% 100%;
          &.prevPage {
            background-image: url('https://static.hudongmiao.com/joymewH5/img/guessLanternRiddle/leftArrow.png');
          }
          &.nextPage {
            background-image: url('https://static.hudongmiao.com/joymewH5/img/guessLanternRiddle/rightArrow.png');
          }
        }
      }
    }
