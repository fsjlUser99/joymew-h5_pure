<template>
  ...
  <div class="main">
    ...
    <img
      src="https://static.hudongmiao.com/joymewH5/img/shake/v2/shakeHandOn.png"
      alt="摇一摇手"
      class="shakeHand shakeAni"
    />
    <img
      src="https://static.hudongmiao.com/joymewH5/img/shake/v2/city.png"
      alt="城市"
      class="city"
    />
    <broad
...
.main {
  ...
  background-image: url('https://static.hudongmiao.com/joymewH5/img/shake/v2/onBg.png');
  .scoreBox {
